...
public class Controlador {
	...
	public static ResultSet consultaAlumno(String dni) {
		ResultSet datos;
		datos = conexion.getQuery("SELECT * FROM alumnos where DNI ='"+dni+"'");
		return datos;	
	}
	...
	public static String consultaAlumnos() {
		...
		datos = conexion.getQuery("SELECT * FROM alumnos;");
		try {
			while (datos.next()) {
	...
	public static String borrarAlumno(String dni) {
		...
		try {
			ok = conexion.setQuery("delete from alumnos where DNI='"+dni+"'");
