...
public class VentanaInteresado extends JFrame {
	...
	class Panel extends JPanel implements ActionListener {
		...
		JTextField textfield1, textfield2, textfield3, textfield4, textfield5, textfield6, textfield7, textfield8,textfield9, textfield10, textfield11,textfield12, textfield13;
		...
		public void CargarCursos() {
			ResultSet datos;		
			datos = VentanaPrincipal.conexion.getQuery("SELECT CodigoCurso FROM cursos");
			try {
				while (datos.next())
	...
	if (botonPulsado == consultar) {
				...
				if (textfield3.getText().equals("")) {
					...
					textfield10.setText("");
					textfield11.setText("");					
					textareaconsulta.setText(Interesado.consultaAlumnos());
				}
			...
			if (botonPulsado == modificar) {
				textareaconsulta.setText(Interesado.modificarAlumno(
						textfield1.getText(),
						textfield2.getText(),
						textfield3.getText(),
						textfield4.getText(),
